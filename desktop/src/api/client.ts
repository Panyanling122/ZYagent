...
export const api = {
  workspaces: {
    ...
    update: (id: string, data: Record<string, unknown>) => request(`/api/workspaces/${id}`, { method: "PUT", body: JSON.stringify(data) }),
